					<div class="inner-sections" id="inner-sections">
			            ...
			            <p>The core curriculum covers the four language skills: speaking, listening, reading and writing, with a strong emphasis on speaking and listening.</p>
							</div>
						</div>
								...
								<div class="study-plans-list">
									...
									<div class="study-plan-item">
										...
										<div class="study-plan-content">
											<p>The two beginner courses set the foundation for speaking English with confidence. Following the second course we recommend that students take the Movers test.</p>
											<div class="course-details">
												...
												<div class="course-detail-block">
													<label>IELTS</label>
													<span><?php echo !empty($rec->ielts) ? $rec->ielts : '---';?></span>
												</div>
												<div class="course-detail-block">
													<label>TOEFL.IBT</label>
													<span><?php echo !empty($rec->toefl_ibt) ? $rec->toefl_ibt : '---';?></span>
												</div>
												<div class="course-detail-block">
													<label>TOEIC (Listening / Reading)</label>
													<span><?php echo !empty($rec->toeic_reading) ? $rec->toeic_reading : '---';?></span>
												</div>
												<div class="course-detail-block">
													<label>TOEIC (Speaking / Writing)</label>
													<span><?php echo !empty($rec->toeic_writing) ? $rec->toeic_writing : '---';?></span>
												</div>
											</div>
