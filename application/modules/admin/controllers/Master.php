    ...
    function list_cities() {
        ...
        $data['cities'] = $this->Custom_model->fetch_data(CITIES, array(
            ...
            CITIES_LANG . '.language_id'
                ), array(), array(CITIES_LANG => CITIES_LANG . '.city_id=' . CITIES . '.id AND ' . CITIES_LANG . '.language_id=' . $selected_lang), $search = '', $order = CITIES . '.id'
        );
    ...
    function list_districts() {
        ...
        $data['districts'] = $this->Custom_model->fetch_data(DISTRICTS, array(
            ...
            DISTRICTS_LANG . '.language_id'
                ), array(), array(DISTRICTS_LANG => DISTRICTS_LANG . '.district_id=' . DISTRICTS . '.id AND ' . DISTRICTS_LANG . '.language_id=' . $selected_lang), $search = '', $order = DISTRICTS . '.id'
        );
    ...
    function list_course_categories() {
        ...
        $data['categories'] = $this->Custom_model->fetch_data(COURSE_CATEGORIES, array(
            ...
            COURSE_CATEGORIES_LANG . '.language_id'
                ), array(), array(COURSE_CATEGORIES_LANG => COURSE_CATEGORIES_LANG . '.course_category_id=' . COURSE_CATEGORIES . '.id AND ' . COURSE_CATEGORIES_LANG . '.language_id=' . $selected_lang), $search = '', $order = COURSE_CATEGORIES . '.id'
        );
