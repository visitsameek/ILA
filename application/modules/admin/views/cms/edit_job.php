                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="post">
						<div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="job" name="job" value="<?php echo isset($job_details->job) ? $job_details->job : ""; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="job_title" name="job_title" value="<?php echo isset($job_details->job_title) ? $job_details->job_title : ""; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div> 						
						<div class="form-group">
                                ...
                                <select id="city_id" name="city_id" class="form-control col-md-7 col-xs-12" >
                                    ...
                                    if(!empty($city_list)){
                                        foreach ($city_list as $city){ ?>
                                            <option value="<?php echo $city->id; ?>" <?php echo $job_details->city_id == $city->id ? 'selected' : '';?>><?php echo $city->city; ?></option>
                                       <?php  }
                                    }
                                    ?>
                                </select>
						...
						<div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="contact_phone" name="contact_phone" value="<?php echo isset($job_details->contact_phone) ? $job_details->contact_phone : ""; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
						<div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="contact_email" name="contact_email" value="<?php echo isset($job_details->contact_email) ? $job_details->contact_email : ""; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
						<div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="job_level" name="job_level" value="<?php echo isset($job_details->job_level) ? $job_details->job_level : ""; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
						<div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="job_department" name="job_department" value="<?php echo isset($job_details->job_department) ? $job_details->job_department : ""; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea rows="10" name="job_info" id="job_info" class="form-control col-md-7 col-xs-12"><?php echo isset($job_details->job_info) ? $job_details->job_info : ""; ?></textarea>
                            </div>
                        </div>
						<div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea rows="10" name="job_requirement" id="job_requirement" class="form-control col-md-7 col-xs-12"><?php echo isset($job_details->job_requirement) ? $job_details->job_requirement : ""; ?></textarea>
                            </div>
                        </div>
