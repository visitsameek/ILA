                ...
                <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="post">
						<div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="page_name">Community Network <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="community" name="community" value="<?php echo isset($network_details->community) ? $network_details->community : ""; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="title" name="title" value="<?php echo isset($network_details->title) ? $network_details->title : ""; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div> 
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea rows="10" name="content" id="content" class="form-control col-md-7 col-xs-12"><?php echo isset($network_details->content) ? $network_details->content : ""; ?></textarea>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#submit').click(function(e){        
           if($('#community').val()==""){         
               $("#community").parent().append("<div class='validation'>Please enter community network</div>");
                return false;
           }else if($('#title').val()==""){         
