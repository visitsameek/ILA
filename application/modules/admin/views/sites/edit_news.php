                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="post">
						<div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="news" name="news" value="<?php echo isset($news_details->news) ? $news_details->news : ""; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="title" name="title" value="<?php echo isset($news_details->title) ? $news_details->title : ""; ?>" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>              
						<div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
								<?php 
								 ...
								 ?>
                                <input type="text" id="news_date" name="news_date" value="<?php echo isset($news_details->news_date) ? $news_date[1].'/'.$news_date[2].'/'.$news_date[0] : ""; ?>" class="form-control">
                            </div>
                        </div>
						<div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea name="short_desc" id="short_desc" class="form-control col-md-7 col-xs-12"><?php echo isset($news_details->short_desc) ? $news_details->short_desc : ""; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea rows="10" name="content" id="content" class="form-control col-md-7 col-xs-12"><?php echo isset($news_details->content) ? $news_details->content : ""; ?></textarea>
                            </div>
                        </div>
						<div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">News Image </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="pv" id="preview">
                                <?php load_medias($news_details->media_id, $input_media_id = '#input-media', true); ?>
                            </div>
                                <input id="input-media" type="hidden" value="<?php echo $news_details->media_id; ?>" name="media_id" class="form-control" />
								<!-- Large modal -->
