                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="" method="post">
                     <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="district" name="district" class="form-control col-md-7 col-xs-12" value="<?php echo isset($district_details->district) ? $district_details->district : ""; ?>"  >
                            </div>
                        </div>                        
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="district_name" name="district_name"  class="form-control col-md-7 col-xs-12" value="<?php echo isset($district_details->district_name) ? $district_details->district_name : ""; ?>">
                            </div>
                        </div> 
						<div class="form-group">
                                ...
                                <select id="city_id" name="city_id" class="form-control col-md-7 col-xs-12" >
                                    ...
                                    if(!empty($city_list)){
                                        foreach ($city_list as $city){ ?>
                                            <option value="<?php echo $city->id; ?>" <?php echo ($district_details->city_id==$city->id) ? "selected" : ""; ?>><?php echo $city->city; ?></option>
                                       <?php  }
                                    }
                                    ?>
                                </select>
